...
def recalc(filename, timeout=30):
    ...
    if result.returncode != 0 and result.returncode != 124:  # 124 是超时退出代码
...
def main():
    if len(sys.argv) < 2:
        ...
        print("  - error_summary: 按错误类型及其位置的详细分类")
